  ...
  return (
    <div className="md:col-span-8 glass-card p-2xl rounded-xl shadow-lg flex flex-col justify-center">
      ...
      <div className="flex flex-wrap gap-lg">
        <button className="flex items-center gap-sm px-12 py-4 bg-primary text-on-primary text-headline-md font-semibold rounded-xl shadow-lg hover:bg-primary-container transition-all active:scale-95 group">
          Ingresar
          <span className="material-symbols-outlined group-hover:translate-x-1 transition-transform">
            arrow_forward
          </span>
        </button>
        <button className="px-12 py-4 bg-white border-2 border-primary text-primary text-headline-md font-semibold rounded-xl hover:bg-primary/5 transition-all active:scale-95">
          Registrar
        </button>
      </div>
